...
var Providers = []Provider{
	...
	{ID: "openrouter", Name: "OpenRouter", EnvVar: "OPENROUTER_API_KEY",
		...
		Models:       []string{"openrouter/qwen/qwen3-coder:free", "openrouter/nvidia/nemotron-3-nano-30b-a3b:free", "openrouter/anthropic/claude-sonnet-4-6", "openrouter/openai/gpt-4.1", "openrouter/google/gemini-2.5-pro"},
		NeedsKey:     true},
