...
// SentinelSurfaceEffectivenessSummary aggregates browser-surface pressure and
// outcomes by experiment arm so browser-wide issues can be separated from
// recipe-specific regressions.
type SentinelSurfaceEffectivenessSummary struct {
	ProbeType          string    `json:"probeType,omitempty"`
	API                string    `json:"api,omitempty"`
	VariantBundleID    string    `json:"variantBundleId,omitempty"`
	TrustRecipeID      string    `json:"trustRecipeId,omitempty"`
...
type SentinelSiteIntelligenceSummary struct {
	Domain                    string    `json:"domain,omitempty"`
	TopScriptURL              string    `json:"topScriptUrl,omitempty"`
	TopProbeFamily            string    `json:"topProbeFamily,omitempty"`
	DominantChallengeVendor   string    `json:"dominantChallengeVendor,omitempty"`
	PressureScore             int       `json:"pressureScore"`
	ActiveRecommendationCount int       `json:"activeRecommendationCount"`
	LatestCanaryStatus        string    `json:"latestCanaryStatus,omitempty"`
	LastSeenAt                time.Time `json:"lastSeenAt,omitempty"`
}

type SentinelProbeSequenceSummary struct {
	Domain                string    `json:"domain,omitempty"`
	ScriptURL             string    `json:"scriptUrl,omitempty"`
	...
	LatestOutcome         string    `json:"latestOutcome,omitempty"`
	LatestChallengeVendor string    `json:"latestChallengeVendor,omitempty"`
	LatestCanaryStatus    string    `json:"latestCanaryStatus,omitempty"`
	LastSeenAt            time.Time `json:"lastSeenAt,omitempty"`
}
...
func (noopSentinelProvider) SummarizeSiteIntelligence(ctx context.Context) ([]SentinelSiteIntelligenceSummary, error) {
	return nil, ErrUnavailable
}
